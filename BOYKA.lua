...
sudo_users = {SUDO,1466455779,1622822810,1791131231}   
...
usertext = '\n • العضو » ['..result.title_..'](t.me/'..(username or 'Ash_ley8')..')'
status  = '\n • تم ترقيته مطور'
...
usertext = '\n • العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Ash_ley8')..')'
status  = '\n • تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' • العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ash_ley8')..') \n • '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," • العضو : {["..data.first_name_.."](T.ME/Ash_ley8)}\n • ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","خول","يكسمك","يمتناك","يطيز","يشرمط"}
for k,v in pairs(list) do
...
send(msg.chat_id_,0, " • عذرا » {["..data.first_name_.."](T.ME/Ash_ley8)}\n • عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
- ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏụʀᴄᴇ ᴀѕʜʟᴇʏ.
مرحبا بك في سورس اشلي.💞
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 𝙰𝙻-𝙰𝙱𝙰𝙳𝙸.',url="t.me/Alabadi30"}},
{{text = '- 𝚂𝙾𝚄𝚁𝙲𝙴.',url="t.me/Ash_ley8"}},
}
{{text = '- 𝚃𝚆𝚂𝙻.',url="t.me/twsl7bot"}},
}
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' • بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Ash_ley8')..') \n • تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' • بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Ash_ley8')..') \n • تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n • اهلا بك في متجر ملفات اشلي\n • ملفات السورس ↓\n─────── 𝐴𝑆 ───────
\n\n"
local TextE = "\n─────── 𝐴𝑆 ───────
\n • علامة تعني { ✓ } ملف مفعل\n • علامة تعني { ✘ } ملف معطل\n • قناة سورس اشلي ↓\n".." • [اضغط هنا لدخول](t.me/Ash_ley8) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," • عذرا الملف لايدعم سورس اشلي \n") 
end
return false
end
...
local UserName = (b.username_ or "Ash_ley8")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n • لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Ash_ley8')..')'
status  = '\n • تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n • العضو » '..userid..''
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n • العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Ash_ley8')..')'..'\n • تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'اشلي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'اشلي')
local BOYKA_Msg = {
'يوه '..Namebot..' زهق منك😒',
'نعم ياعيون '..Namebot..' 😻💓',
'عايز اي من '..Namebot..' 🙄💛',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اشلي').." غادر" or text == 'غادر' then  
...
if text == 'مطور اشلي' or text == 'مطور' or text == 'اشلي' then
local Text = [[
⛨︙مطور السورس يمكنك..💓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝖆𝖍𝖒𝖊𝖉 𝖆𝖑𝖆𝖇𝖆𝖉𝖎⁦♡⁩' ,url="t.me/Alabadi30"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Ash_ley8')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚂𝙷𝙻𝙴𝚈  ㇱ ', url="t.me/Ash_ley8"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'اشلي')
